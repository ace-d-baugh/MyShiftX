...
const FAQS: { q: string; a: string; importOnly?: boolean }[] = [
  ...
  },
  {
    ...
    a: "Yes to both. On My Calendar, use the grid/list toggle near the top of the page to switch between the month grid and a day-by-day list (list view tends to read better on a phone), and your choice is remembered for next time. To add a shift for a particular day, just tap any empty space on that day in either view — it opens the new-shift form with that date already filled in. This works on today and any future day; past days aren't clickable.",
  },
  {
    q: 'Someone covered my shift request — how do I close it out?',
    a: "Open the ⋮ menu on your own request and choose Mark Fulfilled, then confirm. Use this when someone actually covered the shift for you, even if it was arranged in person or over text rather than through the app — there's no way for us to detect that automatically. It files the request as fulfilled rather than just letting it expire, which keeps your board's history accurate.",
  },
  {
