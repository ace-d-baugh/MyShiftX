export default function Body() {
  return (
    <>
      ...
      <h2>Where the Mistakes Usually Are</h2>
      ...
      <h2>How to Check Efficiently</h2>
      ...
      <ol>
        <li>Open your personal log for the pay period.</li>
        <li>Open the payslip.</li>
        <li>Tick off each shift as you find it.</li>
        <li>Note any shift that is missing, paid at the wrong rate, or missing a premium.</li>
        <li>Check the overtime total against your own calculation of the week.</li>
      </ol>
      ...
      <ul>
        <li>The date and times</li>
        <li>The location and role</li>
        <li>What you expected to see</li>
        <li>What actually appears (or does not)</li>
      </ul>
      ...
      <h2>Why Swaps and Multi-Site Work Create More Errors</h2>
      ...
      <ul>
        <li><strong>Restaurants &amp; bars</strong> — tips, station differentials, and weekend premiums are common sources of mismatch. Traded closes are especially prone to being paid to the wrong person.</li>
        <li><strong>Healthcare</strong> — night and weekend differentials, float assignments, and overtime thresholds create frequent discrepancies.</li>
        <li><strong>Warehouse</strong> — overtime week boundaries and shift differentials are the usual places errors appear.</li>
        <li><strong>Hotels &amp; attractions</strong> — multi-property work and role-based rates increase the chance of the wrong code being applied.</li>
      </ul>

      <h2>What to Do If the First Response Is Vague</h2>
