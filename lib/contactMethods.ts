...
export const CONTACT_METHOD_META: Record<ContactMethodType, ContactMethodMeta> = {
  phone: { label: 'Phone', icon: Phone, hrefPrefix: 'tel:', inputType: 'tel', placeholder: '(555) 555-0000' },
  email: { label: 'Email', icon: Mail, hrefPrefix: 'mailto:', inputType: 'email', placeholder: 'you@example.com' },
  instagram: { label: 'Instagram', icon: FaInstagram, inputType: 'text', placeholder: '@yourhandle' },
  facebook: { label: 'Facebook', icon: FaFacebook, inputType: 'text', placeholder: 'facebook.com/yourhandle' },
  twitter: { label: 'X (Twitter)', icon: FaXTwitter, inputType: 'text', placeholder: '@yourhandle' },
  tiktok: { label: 'TikTok', icon: FaTiktok, inputType: 'text', placeholder: '@yourhandle' },
  discord: { label: 'Discord', icon: FaDiscord, inputType: 'text', placeholder: 'yourhandle' },
  snapchat: { label: 'Snapchat', icon: FaSnapchat, inputType: 'text', placeholder: '@yourhandle' },
  linkedin: { label: 'LinkedIn', icon: FaLinkedin, inputType: 'text', placeholder: 'linkedin.com/in/yourhandle' },
  other: { label: 'Other / Social', icon: Link2, inputType: 'text', placeholder: 'Insta @yourhandle' },
}
