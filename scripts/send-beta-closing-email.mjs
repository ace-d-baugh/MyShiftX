        ...
        <table width="560" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;width:100%;background-color:#ffffff;border-radius:10px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
          <tr>
            <td align="center" style="background-color:#F0E2FF;background-image:linear-gradient(148deg, rgba(255,255,255,0.25) 0%, transparent 38%),linear-gradient(135deg, rgba(60,0,140,0.38) 0%, transparent 52%),linear-gradient(315deg, rgba(70,5,150,0.34) 0%, transparent 52%),linear-gradient(225deg, rgba(50,0,130,0.26) 0%, transparent 48%),linear-gradient(45deg, rgba(65,5,145,0.24) 0%, transparent 48%);padding:32px 24px;text-align:center;">
              <img src="https://myshiftx.com/logos/ShiftX-logo-sm.png" alt="MyShiftX" width="200" height="50" style="display:block;border:0;margin:0 auto;" />
            </td>
          </tr>
          <tr>
            <td style="padding:32px 32px 24px;">
              ...
              <p style="margin:0 0 16px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.6;color:#5a4a6e;">Beta testing is sadly wrapping up tonight. MyShiftX will go dark while I process everyone&rsquo;s feedback and get ready for what&rsquo;s next.</p>
              ...
              <p style="margin:16px 0 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#9b8ab4;line-height:1.5;">Thank you for being some of the very first people to use MyShiftX, break it, and tell me what needed to change. This isn&rsquo;t goodbye &mdash; just see you soon.</p>
            </td>
          </tr>
          <tr>
