  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
        {/* eslint-disable-next-line @next/next/no-img-element -- captured by html-to-image, next/image would inject markup the capture can't resolve */}
        <img
          src="/logos/MyShiftX-Full-Logo-Gradient.png"
          alt="MyShiftX"
      ...
      <div style={{ textAlign: 'right', borderTop: '1px solid #eee', paddingTop: 10, marginTop: 2 }}>
        <div style={{ fontSize: 12, color: '#999' }}>Posted to MyShiftX.com</div>
